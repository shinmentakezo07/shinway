...
// embed shinway without importing internal packages.
package config

import internalconfig "github.com/shinmentakezo07/shinway/v7/internal/config"
...
type NVIDIAKey = internalconfig.NVIDIAKey
type NVIDIAModel = internalconfig.NVIDIAModel
type ZenKey = internalconfig.ZenKey
type ZenModel = internalconfig.ZenModel
type TokenRouterKey = internalconfig.TokenRouterKey
type TokenRouterModel = internalconfig.TokenRouterModel
type OrcaRouterKey = internalconfig.OrcaRouterKey
type OrcaRouterModel = internalconfig.OrcaRouterModel
