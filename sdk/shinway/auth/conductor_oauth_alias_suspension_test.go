...
func (e *aliasRoutingExecutor) Execute(ctx context.Context, _ *Auth, req shinwayexecutor.Request, _ shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.mu.Lock()
...
func (e *aliasRoutingExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
...
func (e *aliasRoutingExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
...
func TestManagerExecute_OAuthAliasBypassesBlockedRouteModel(t *testing.T) {
	...
	resp, errExecute := manager.Execute(context.Background(), []string{provider}, shinwayexecutor.Request{Model: routeModel}, shinwayexecutor.Options{})
	if errExecute != nil {
