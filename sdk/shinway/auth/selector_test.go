...
func TestFillFirstSelectorPick_Deterministic(t *testing.T) {
	...
	got, err := selector.Pick(context.Background(), "gemini", "", shinwayexecutor.Options{}, auths)
	if err != nil {
...
func TestWeightedRoundRobinSelectorPick_DistributesAndSkipsNonPositiveWeights(t *testing.T) {
	...
	for index := 0; index < 100; index++ {
		got, errPick := selector.Pick(context.Background(), "gemini", "model", shinwayexecutor.Options{}, auths)
		if errPick != nil {
...
func TestWeightedRoundRobinSelectorPick_ResetsCreditsWhenWeightsChange(t *testing.T) {
	...
	for index := 0; index < 1000; index++ {
		if _, errPick := selector.Pick(context.Background(), "gemini", "model", shinwayexecutor.Options{}, auths); errPick != nil {
...
func TestWeightedRoundRobinSelectorPick_SkipsUnavailableAndQuotaExceededWithoutRecovery(t *testing.T) {
	...
	gotModel, errModel := selector.Pick(context.Background(), "gemini", model, shinwayexecutor.Options{}, auths)
	if errModel != nil || gotModel == nil || gotModel.ID != "available" {
		t.Fatalf("model Pick() = %#v, %v; want available", gotModel, errModel)
	}
	for index := 0; index < 4; index++ {
		gotAuth, errAuth := selector.Pick(context.Background(), "gemini", "", shinwayexecutor.Options{}, auths)
...
func TestRoundRobinSelectorPick_PriorityBuckets(t *testing.T) {
	...
	want := []string{"a", "b", "a", "b"}
	for i, id := range want {
		got, err := selector.Pick(context.Background(), "mixed", "", shinwayexecutor.Options{}, auths)
		if err != nil {
			t.Fatalf("Pick() #%d error = %v", i, err)
		}
		if got == nil {
...
func TestFillFirstSelectorPick_PriorityFallbackCooldown(t *testing.T) {
	...
	got, err := selector.Pick(context.Background(), "mixed", model, shinwayexecutor.Options{}, []*Auth{high, low})
	if err != nil {
		t.Fatalf("Pick() error = %v", err)
	}
	if got == nil {
...
func TestSelectorPick_AllCooldownReturnsModelCooldownError(t *testing.T) {
	...
	t.Run("mixed provider redacts provider field", func(t *testing.T) {
		...
		selector := &FillFirstSelector{}
		_, err := selector.Pick(context.Background(), "mixed", model, shinwayexecutor.Options{}, auths)
		if err == nil {
	...
	t.Run("non-mixed provider includes provider field", func(t *testing.T) {
		...
		selector := &FillFirstSelector{}
		_, err := selector.Pick(context.Background(), "gemini", model, shinwayexecutor.Options{}, auths)
		if err == nil {
			t.Fatalf("Pick() error = nil")
		}
...
func TestFillFirstSelectorPick_ThinkingSuffixFallsBackToBaseModelState(t *testing.T) {
	...
	got, err := selector.Pick(context.Background(), "mixed", requestedModel, shinwayexecutor.Options{}, []*Auth{high, low})
	if err != nil {
		t.Fatalf("Pick() error = %v", err)
	}
	if got == nil {
...
func TestRoundRobinSelectorPick_ThinkingSuffixSharesCursor(t *testing.T) {
	...
	first, err := selector.Pick(context.Background(), "gemini", "test-model(high)", shinwayexecutor.Options{}, auths)
	if err != nil {
		t.Fatalf("Pick() first error = %v", err)
	}
	second, err := selector.Pick(context.Background(), "gemini", "test-model(low)", shinwayexecutor.Options{}, auths)
	if err != nil {
...
func TestRoundRobinSelectorPick_CursorKeyCap(t *testing.T) {
	...
	_, _ = selector.Pick(context.Background(), "gemini", "m1", shinwayexecutor.Options{}, auths)
	_, _ = selector.Pick(context.Background(), "gemini", "m2", shinwayexecutor.Options{}, auths)
	_, _ = selector.Pick(context.Background(), "gemini", "m3", shinwayexecutor.Options{}, auths)
...
func TestSessionAffinitySelector_SameSessionSameAuth(t *testing.T) {
	...
	opts := shinwayexecutor.Options{OriginalRequest: payload}
...
func TestSessionAffinitySelector_WeightedBindingRebindsAfterWeightBecomesZero(t *testing.T) {
	...
	auths := []*Auth{authA, authB}
	opts := shinwayexecutor.Options{OriginalRequest: []byte(`{"metadata":{"user_id":"user_xxx_account__session_weight-change"}}`)}
...
func TestSessionAffinitySelector_WeightedNewSessionsResetAfterWeightChange(t *testing.T) {
	...
	pickSession := func(index int) *Auth {
		t.Helper()
		opts := shinwayexecutor.Options{OriginalRequest: []byte(fmt.Sprintf(`{"session_id":"session-%d"}`, index))}
...
func TestSessionAffinitySelector_DifferentSessionsDifferentAuths(t *testing.T) {
	...
	opts1 := shinwayexecutor.Options{OriginalRequest: session1}
	opts2 := shinwayexecutor.Options{OriginalRequest: session2}
...
func TestExtractSessionID_DerivedSessionAndExplicitPriority(t *testing.T) {
	...
	metadata := map[string]any{shinwayexecutor.DerivedSessionIDMetadataKey: "ctx:v1:derived-root"}
	...
	executionMetadata := map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "execution-session",
		shinwayexecutor.DerivedSessionIDMetadataKey: "ctx:v1:derived-root",
	}
...
func TestSessionAffinitySelector_ThreeScenarios(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			opts := shinwayexecutor.Options{OriginalRequest: tc.payload}
	...
	t.Run("Scenario2And3_SameAuth", func(t *testing.T) {
		...
		opts2 := shinwayexecutor.Options{OriginalRequest: openaiS2}
		opts3 := shinwayexecutor.Options{OriginalRequest: openaiS3}
	...
	t.Run("Scenario1To2_InheritBinding", func(t *testing.T) {
		...
		opts1 := shinwayexecutor.Options{OriginalRequest: s1}
		opts2 := shinwayexecutor.Options{OriginalRequest: s2}
...
func TestSessionAffinitySelectorBodyIdentifierTransitionsPreserveBinding(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			first, err := selector.Pick(context.Background(), provider, "gpt-test", shinwayexecutor.Options{OriginalRequest: tt.firstPayload}, auths)
			if err != nil {
				t.Fatalf("first Pick() error = %v", err)
			}
			second, err := selector.Pick(context.Background(), provider, "gpt-test", shinwayexecutor.Options{OriginalRequest: bothPayload}, auths)
			if err != nil {
...
func TestSessionAffinitySelectorCombinedIdentifiersBindConversationFallback(t *testing.T) {
	...
	first, err := selector.Pick(context.Background(), provider, "gpt-test", shinwayexecutor.Options{OriginalRequest: combined}, auths)
	if err != nil {
		t.Fatalf("combined-identifier Pick() error = %v", err)
	}
	second, err := selector.Pick(context.Background(), provider, "gpt-test", shinwayexecutor.Options{OriginalRequest: conversationOnly}, auths)
	if err != nil {
...
func TestSessionAffinitySelectorPrimaryTrafficKeepsConversationAliasAlive(t *testing.T) {
	...
	first, err := selector.Pick(context.Background(), provider, model, shinwayexecutor.Options{OriginalRequest: combined}, auths)
	if err != nil {
	...
	primary, err := selector.Pick(context.Background(), provider, model, shinwayexecutor.Options{OriginalRequest: promptOnly}, auths)
	if err != nil {
	...
	fallback, err := selector.Pick(context.Background(), provider, model, shinwayexecutor.Options{OriginalRequest: conversationOnly}, auths)
	if err != nil {
		t.Fatalf("conversation-only Pick() error = %v", err)
	}
...
func TestSessionAffinitySelectorSharedPromptKeyPreservesConversationAliases(t *testing.T) {
	...
	first, err := selector.Pick(context.Background(), provider, model, shinwayexecutor.Options{OriginalRequest: combinedA}, auths)
	if err != nil {
		t.Fatalf("conversation A combined Pick() error = %v", err)
	}
	second, err := selector.Pick(context.Background(), provider, model, shinwayexecutor.Options{OriginalRequest: combinedB}, auths)
	if err != nil {
	...
	for name, payload := range map[string][]byte{"conversation A": conversationA, "conversation B": conversationB} {
		picked, errPick := selector.Pick(context.Background(), provider, model, shinwayexecutor.Options{OriginalRequest: payload}, auths)
		if errPick != nil {
...
func TestSessionAffinitySelectorConversationIDContainingPromptMarkerRemainsStable(t *testing.T) {
	...
	second, err := selector.Pick(context.Background(), provider, model, shinwayexecutor.Options{OriginalRequest: conversationOnly}, auths)
	if err != nil {
		t.Fatalf("conversation-only Pick() error = %v", err)
	}
	if second.ID != first.ID {
...
func TestSessionAffinitySelectorUsesRequestPayloadWhenOriginalRequestMissing(t *testing.T) {
	...
	_, opts := shinwaysession.Enrich(request, shinwayexecutor.Options{
