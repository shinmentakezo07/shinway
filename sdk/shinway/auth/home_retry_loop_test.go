...
func (e *unauthorizedHomeExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.calls.Add(1)
	return shinwayexecutor.Response{}, &Error{HTTPStatus: http.StatusUnauthorized, Message: "missing access token"}
}

func (e *unauthorizedHomeExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	e.calls.Add(1)
...
func (e *unauthorizedHomeExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.calls.Add(1)
	return shinwayexecutor.Response{}, &Error{HTTPStatus: http.StatusUnauthorized, Message: "missing access token"}
}
...
func TestManagerExecuteHomeStopsWhenDispatchRepeatsTriedAuth(t *testing.T) {
	...
	_, err := manager.Execute(ctx, []string{"home-loop-test"}, shinwayexecutor.Request{Model: "gemini-3.5-flash-low"}, shinwayexecutor.Options{})
	if err == nil {
