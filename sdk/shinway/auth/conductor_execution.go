...
import (
	...
	shinwaysession "github.com/shinmentakezo07/shinway/v7/sdk/shinway/session"
...
func (m *Manager) Execute(ctx context.Context, providers []string, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	req, opts = shinwaysession.Enrich(req, opts)
	normalized := m.normalizeProviders(providers)
	if len(normalized) == 0 {
		return shinwayexecutor.Response{}, &Error{Code: "provider_not_found", Message: "no provider supplied"}
	}
	if m.HomeEnabled() {
	...
	for attempt := 0; ; attempt++ {
		...
		if isRequestTerminatedError(errExec) {
			return shinwayexecutor.Response{}, errExec
		}
		lastErr = errExec
	...
	return shinwayexecutor.Response{}, &Error{Code: "auth_not_found", Message: "no auth available"}
}

// It supports multiple providers for the same model and round-robins the starting provider per model.
func (m *Manager) ExecuteCount(ctx context.Context, providers []string, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	req, opts = shinwaysession.Enrich(req, opts)
	normalized := m.normalizeProviders(providers)
	if len(normalized) == 0 {
		return shinwayexecutor.Response{}, &Error{Code: "provider_not_found", Message: "no provider supplied"}
...
// It supports multiple providers for the same model and round-robins the starting provider per model.
func (m *Manager) ExecuteStream(ctx context.Context, providers []string, req shinwayexecutor.Request, opts shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	req, opts = shinwaysession.Enrich(req, opts)
	if m.HomeEnabled() {
...
type requestToFormatResolver interface {
	RequestToFormat(req shinwayexecutor.Request, opts shinwayexecutor.Options) sdktranslator.Format
}

func isRequestTerminatedError(err error) bool {
	var terminated *shinwayexecutor.RequestTerminatedError
	return errors.As(err, &terminated) && terminated != nil
}

func applyRequestAfterAuthInterceptor(ctx context.Context, executor ProviderExecutor, provider string, req shinwayexecutor.Request, opts shinwayexecutor.Options, requestedModel string) (shinwayexecutor.Request, shinwayexecutor.Options, error) {
	if opts.RequestAfterAuthInterceptor == nil {
		return req, opts, nil
	}
	toFormat := requestToFormat(provider, executor, req, opts)
	resp := opts.RequestAfterAuthInterceptor(ctx, shinwayexecutor.RequestAfterAuthInterceptRequest{
	...
	if resp.Terminate {
		return req, opts, &shinwayexecutor.RequestTerminatedError{
...
func requestToFormat(provider string, executor ProviderExecutor, req shinwayexecutor.Request, opts shinwayexecutor.Options) sdktranslator.Format {
...
func (m *Manager) executeMixedOnce(ctx context.Context, providers []string, req shinwayexecutor.Request, opts shinwayexecutor.Options, maxRetryCredentials int) (shinwayexecutor.Response, error) {
	if len(providers) == 0 {
		return shinwayexecutor.Response{}, &Error{Code: "provider_not_found", Message: "no provider supplied"}
	}
	...
	for {
		...
		if errPick != nil {
			...
			return shinwayexecutor.Response{}, errPick
		}
		...
		if authErr != nil {
			if isRequestInvalidError(authErr) {
				return shinwayexecutor.Response{}, authErr
			}
			lastErr = authErr
			if homeMode {
				homeAuthCount++
...
func (m *Manager) executeCountMixedOnce(ctx context.Context, providers []string, req shinwayexecutor.Request, opts shinwayexecutor.Options, maxRetryCredentials int) (shinwayexecutor.Response, error) {
	if len(providers) == 0 {
		return shinwayexecutor.Response{}, &Error{Code: "provider_not_found", Message: "no provider supplied"}
	}
	routeModel := authSelectionModelFromOptions(opts, req.Model)
...
func (m *Manager) executeStreamMixedOnce(ctx context.Context, providers []string, req shinwayexecutor.Request, opts shinwayexecutor.Options, maxRetryCredentials int) (*shinwayexecutor.StreamResult, error) {
	if len(providers) == 0 {
		return nil, &Error{Code: "provider_not_found", Message: "no provider supplied"}
	}
	routeModel := authSelectionModelFromOptions(opts, req.Model)
...
func ensureRequestedModelMetadata(opts shinwayexecutor.Options, requestedModel string) shinwayexecutor.Options {
	...
	if len(opts.Metadata) == 0 {
		opts.Metadata = map[string]any{shinwayexecutor.RequestedModelMetadataKey: requestedModel}
		return opts
	}
	...
	meta[shinwayexecutor.RequestedModelMetadataKey] = requestedModel
	opts.Metadata = meta
	return opts
}

func authSelectionModelFromOptions(opts shinwayexecutor.Options, fallback string) string {
	fallback = strings.TrimSpace(fallback)
	if len(opts.Metadata) == 0 {
		return fallback
	}
	raw, ok := opts.Metadata[shinwayexecutor.AuthSelectionModelMetadataKey]
	if !ok || raw == nil {
		return fallback
	}
...
func executionModelForAuthSelection(opts shinwayexecutor.Options, model string) (string, bool) {
...
func withHomeAuthCount(opts shinwayexecutor.Options, count int) shinwayexecutor.Options {
	if count <= 0 {
		count = 1
	}
	meta := make(map[string]any, len(opts.Metadata)+1)
...
func hasRequestedModelMetadata(meta map[string]any) bool {
	...
	raw, ok := meta[shinwayexecutor.RequestedModelMetadataKey]
	if !ok || raw == nil {
		return false
	}
	switch v := raw.(type) {
...
func contextWithRequestedModelAlias(ctx context.Context, opts shinwayexecutor.Options, fallback string) context.Context {
...
func requestedModelAliasFromOptions(opts shinwayexecutor.Options, fallback string) string {
	fallback = strings.TrimSpace(fallback)
	if len(opts.Metadata) == 0 {
		return fallback
	}
	raw, ok := opts.Metadata[shinwayexecutor.RequestedModelMetadataKey]
	if !ok || raw == nil {
		return fallback
	}
	switch value := raw.(type) {
...
func reasoningEffortFromOptions(opts shinwayexecutor.Options) string {
	if len(opts.Metadata) == 0 {
		return ""
	}
	raw, ok := opts.Metadata[shinwayexecutor.ReasoningEffortMetadataKey]
	if !ok || raw == nil {
		return ""
	}
	switch value := raw.(type) {
...
func serviceTierFromOptions(opts shinwayexecutor.Options) string {
	return stringMetadataValue(opts.Metadata, shinwayexecutor.ServiceTierMetadataKey)
}

func generateFromOptions(opts shinwayexecutor.Options) (bool, bool) {
	if len(opts.Metadata) == 0 {
		return false, false
	}
	raw, ok := opts.Metadata[shinwayexecutor.GenerateMetadataKey]
	if !ok || raw == nil {
		return false, false
	}
	switch value := raw.(type) {
...
func pinnedAuthIDFromMetadata(meta map[string]any) string {
	...
	raw, ok := meta[shinwayexecutor.PinnedAuthMetadataKey]
	if !ok || raw == nil {
		return ""
	}
	switch val := raw.(type) {
...
func disallowFreeAuthFromMetadata(meta map[string]any) bool {
	...
	raw, ok := meta[shinwayexecutor.DisallowFreeAuthMetadataKey]
	if !ok || raw == nil {
		return false
	}
	switch val := raw.(type) {
...
func publishSelectedAuthMetadata(meta map[string]any, auth *Auth) {
	...
	if authID := strings.TrimSpace(auth.ID); authID != "" {
		meta[shinwayexecutor.SelectedAuthMetadataKey] = authID
		if callback, ok := meta[shinwayexecutor.SelectedAuthCallbackMetadataKey].(func(string)); ok && callback != nil {
			callback(authID)
		}
	}
	if authIndex := strings.TrimSpace(auth.EnsureIndex()); authIndex != "" {
		meta[shinwayexecutor.SelectedAuthIndexMetadataKey] = authIndex
		if callback, ok := meta[shinwayexecutor.SelectedAuthIndexCallbackMetadataKey].(func(string)); ok && callback != nil {
			callback(authIndex)
		}
	}
}
