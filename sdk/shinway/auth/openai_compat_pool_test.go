...
type openAICompatPoolExecutor struct {
	...
	streamPayloads    map[string][]shinwayexecutor.StreamChunk
}

func (e *openAICompatPoolExecutor) Identifier() string { return e.id }

func (e *openAICompatPoolExecutor) Execute(ctx context.Context, auth *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	_ = ctx
	_ = auth
	_ = opts
	e.mu.Lock()
	...
	if len(payload) > 0 {
		return shinwayexecutor.Response{Payload: payload}, nil
	}
	return shinwayexecutor.Response{Payload: []byte(req.Model)}, nil
}

func (e *openAICompatPoolExecutor) ExecuteStream(ctx context.Context, auth *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	_ = ctx
	_ = auth
	_ = opts
	e.mu.Lock()
	...
	chunks := append([]shinwayexecutor.StreamChunk(nil), payloadChunks...)
	e.mu.Unlock()
	ch := make(chan shinwayexecutor.StreamChunk, max(1, len(chunks)))
	if err != nil {
		ch <- shinwayexecutor.StreamChunk{Err: err}
		close(ch)
		return &shinwayexecutor.StreamResult{Headers: http.Header{"X-Model": {req.Model}}, Chunks: ch}, nil
	}
	if !hasCustomChunks {
		ch <- shinwayexecutor.StreamChunk{Payload: []byte(req.Model)}
	} else {
...
func (e *openAICompatPoolExecutor) CountTokens(ctx context.Context, auth *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	_ = ctx
	_ = auth
	_ = opts
	e.mu.Lock()
...
func (e *authScopedOpenAICompatPoolExecutor) Execute(_ context.Context, auth *Auth, req shinwayexecutor.Request, _ shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	call := auth.ID + "|" + req.Model
	e.mu.Lock()
	e.executeCalls = append(e.executeCalls, call)
	e.mu.Unlock()
	return shinwayexecutor.Response{Payload: []byte(call)}, nil
}

func (e *authScopedOpenAICompatPoolExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
...
func (e *authScopedOpenAICompatPoolExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
...
func readOpenAICompatStreamPayload(t *testing.T, streamResult *shinwayexecutor.StreamResult) string {
	t.Helper()
	if streamResult == nil {
...
func TestManagerExecuteCount_OpenAICompatAliasPoolStopsOnInvalidRequest(t *testing.T) {
	...
	_, err := m.ExecuteCount(context.Background(), []string{openAICompatPoolProviderKey}, shinwayexecutor.Request{Model: alias}, shinwayexecutor.Options{})
...
func TestManagerExecute_OpenAICompatAliasPoolRotatesWithinAuth(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		resp, err := m.Execute(context.Background(), []string{openAICompatPoolProviderKey}, shinwayexecutor.Request{Model: alias}, shinwayexecutor.Options{})
		if err != nil {
...
func TestManagerExecute_OpenAICompatAliasPoolStopsOnBadRequest(t *testing.T) {
	...
	_, err := m.Execute(context.Background(), []string{openAICompatPoolProviderKey}, shinwayexecutor.Request{Model: alias}, shinwayexecutor.Options{})
	if err == nil || err.Error() != invalidErr.Error() {
...
func TestManagerExecuteStream_OpenAICompatAliasPoolRetriesOnEmptyBootstrap(t *testing.T) {
	...
	streamResult, err := m.ExecuteStream(context.Background(), []string{openAICompatPoolProviderKey}, shinwayexecutor.Request{Model: alias}, shinwayexecutor.Options{})
	if err != nil {
...
func TestManagerExecuteStream_OpenAICompatAliasPoolStopsOnInvalidRequest(t *testing.T) {
	...
	_, err := m.ExecuteStream(context.Background(), []string{openAICompatPoolProviderKey}, shinwayexecutor.Request{Model: alias}, shinwayexecutor.Options{})
	if err == nil || err.Error() != invalidErr.Error() {
...
func TestManagerExecuteCount_OpenAICompatAliasPoolRotatesWithinAuth(t *testing.T) {
	...
	for i := 0; i < 2; i++ {
		resp, err := m.ExecuteCount(context.Background(), []string{openAICompatPoolProviderKey}, shinwayexecutor.Request{Model: alias}, shinwayexecutor.Options{})
		if err != nil {
