...
import (
	...
	homekv "github.com/shinmentakezo07/shinway/v7/internal/home"
...
func (e *antigravityCreditsFallbackExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, &Error{HTTPStatus: http.StatusNotImplemented, Message: "Execute not implemented"}
}

func (e *antigravityCreditsFallbackExecutor) ExecuteStream(ctx context.Context, _ *Auth, req shinwayexecutor.Request, _ shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	...
	if !creditsRequested {
		ch <- shinwayexecutor.StreamChunk{Err: &Error{HTTPStatus: http.StatusTooManyRequests, Message: "quota exhausted"}}
		close(ch)
		return &shinwayexecutor.StreamResult{Headers: http.Header{"X-Initial": {req.Model}}, Chunks: ch}, nil
	}
	ch <- shinwayexecutor.StreamChunk{Payload: []byte("credits fallback")}
	close(ch)
	return &shinwayexecutor.StreamResult{Headers: http.Header{"X-Credits": {req.Model}}, Chunks: ch}, nil
}
...
func (e *antigravityCreditsFallbackExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
...
func (codexOnlyFailureExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, &Error{HTTPStatus: http.StatusTooManyRequests, Message: "codex quota exhausted"}
}

func (codexOnlyFailureExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
...
func (codexOnlyFailureExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, &Error{HTTPStatus: http.StatusTooManyRequests, Message: "codex quota exhausted"}
}
...
func TestManagerExecuteStream_AntigravityCreditsFallbackAfterBootstrap429(t *testing.T) {
	...
	streamResult, errExecute := manager.ExecuteStream(context.Background(), []string{"antigravity"}, shinwayexecutor.Request{Model: model}, shinwayexecutor.Options{})
	if errExecute != nil {
...
func TestManagerExecuteStream_AntigravityCreditsHomeModeFailsClosedWithoutDispatch(t *testing.T) {
	...
	_, errExecute := manager.ExecuteStream(context.Background(), []string{"antigravity"}, shinwayexecutor.Request{Model: model}, shinwayexecutor.Options{})
	if errExecute == nil {
...
func TestManagerExecuteStream_CodexOnlyDoesNotEnterAntigravityCreditsFallback(t *testing.T) {
	...
	_, errExecute := manager.ExecuteStream(context.Background(), []string{"codex"}, shinwayexecutor.Request{Model: model}, shinwayexecutor.Options{})
	if errExecute == nil {
