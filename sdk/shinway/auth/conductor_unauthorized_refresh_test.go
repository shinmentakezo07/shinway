...
func (e *unauthorizedRefreshExecutor) Execute(_ context.Context, auth *Auth, _ shinwayexecutor.Request, _ shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.mu.Lock()
	...
	e.mu.Unlock()
	if invalid {
		return shinwayexecutor.Response{}, &Error{
			HTTPStatus: http.StatusUnauthorized,
			Message:    "Your authentication token has been invalidated. Please try signing in again.",
		}
	}
	return shinwayexecutor.Response{Payload: []byte(auth.ID + ":" + token)}, nil
}

func (e *unauthorizedRefreshExecutor) ExecuteStream(_ context.Context, auth *Auth, _ shinwayexecutor.Request, _ shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	e.mu.Lock()
	...
	ch <- shinwayexecutor.StreamChunk{Payload: []byte(auth.ID + ":" + token)}
	close(ch)
...
func (e *unauthorizedRefreshExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, &Error{HTTPStatus: http.StatusNotImplemented, Message: "not implemented"}
}
...
func TestManager_Execute_UnauthorizedRefreshesCurrentAuthBeforeFallback(t *testing.T) {
	...
	resp, errExecute := m.Execute(context.Background(), []string{"codex"}, shinwayexecutor.Request{Model: model}, shinwayexecutor.Options{})
	if errExecute != nil {
...
func TestManager_ExecuteStream_UnauthorizedRefreshesCurrentAuthBeforeFallback(t *testing.T) {
	...
	stream, errStream := m.ExecuteStream(context.Background(), []string{"codex"}, shinwayexecutor.Request{Model: model}, shinwayexecutor.Options{})
	if errStream != nil {
