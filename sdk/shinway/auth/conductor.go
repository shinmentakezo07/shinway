...
type ProviderExecutor interface {
	...
	Execute(ctx context.Context, auth *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error)
	...
	ExecuteStream(ctx context.Context, auth *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error)
	// Refresh attempts to refresh provider credentials and returns the updated auth state.
	Refresh(ctx context.Context, auth *Auth) (*Auth, error)
	// CountTokens returns the token count for the given request.
	CountTokens(ctx context.Context, auth *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error)
...
type Selector interface {
	Pick(ctx context.Context, provider, model string, opts shinwayexecutor.Options, auths []*Auth) (*Auth, error)
}
...
type Manager struct {
	...
	// apiKeyModelRouting atomically couples the config generation used to resolve
	// API-key aliases, pools, and model capabilities for an execution attempt.
