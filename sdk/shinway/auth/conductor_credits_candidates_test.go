...
func TestFindAllAntigravityCreditsCandidateAuths_PrefersKnownCreditsThenUnknown(t *testing.T) {
	...
	pinnedOpts := shinwayexecutor.Options{
		Metadata: map[string]any{shinwayexecutor.PinnedAuthMetadataKey: "aa-unknown"},
	}
...
func TestFindAllAntigravityCreditsCandidateAuths_HomeKVUnavailableReturnsError(t *testing.T) {
	...
	candidates, errCandidates := m.findAllAntigravityCreditsCandidateAuths(context.Background(), "claude-sonnet-4-6", shinwayexecutor.Options{})
	if errCandidates == nil {
