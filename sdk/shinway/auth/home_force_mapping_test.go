...
func TestHomeNonForceAliasSessionReuseAndTargetChangeReleasesAccountedModel(t *testing.T) {
	...
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "non-force-alias-session",
		shinwayexecutor.PinnedAuthMetadataKey:       "non-force-alias-auth",
	}}
	for _, model := range []string{"alias-a(high)", "alias-a", "alias-b"} {
		if _, errExecute := manager.Execute(ctx, []string{"force-mapping"}, shinwayexecutor.Request{Model: model}, opts); errExecute != nil {
...
func TestHomeAuthSelectionRouteRetainsRequestedResponseAliasAcrossWebsocketReuse(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.AuthSelectionModelMetadataKey: "route-model",
		shinwayexecutor.RequestedModelMetadataKey:     "client-alias",
		shinwayexecutor.ExecutionSessionMetadataKey:   "auth-selection-route",
		shinwayexecutor.PinnedAuthMetadataKey:         "auth-selection-route-auth",
	}}
	for attempt := 0; attempt < 2; attempt++ {
		response, errExecute := manager.Execute(ctx, []string{"force-mapping"}, shinwayexecutor.Request{Model: "execution-model"}, opts)
		if errExecute != nil {
...
func (authSelectionAliasExecutor) Execute(_ context.Context, _ *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	if lifecycle, ok := opts.ExecutionLifecycle.(interface{ Retain() }); ok {
		lifecycle.Retain()
	}
	return shinwayexecutor.Response{Payload: []byte(`{"model":"` + req.Model + `"}`)}, nil
}
func (authSelectionAliasExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (authSelectionAliasExecutor) Refresh(_ context.Context, auth *Auth) (*Auth, error) {
	return auth, nil
}
func (authSelectionAliasExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
...
func TestHomeForceMappingAliasChangeEndsAndFlushesBeforeRedispatch(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "force-mapping-alias-change",
		shinwayexecutor.PinnedAuthMetadataKey:       "force-mapping-auth",
	}}
...
func (forceMappingAliasChangeExecutor) Execute(_ context.Context, _ *Auth, _ shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	if lifecycle, ok := opts.ExecutionLifecycle.(interface{ Retain() }); ok {
		lifecycle.Retain()
	}
	return shinwayexecutor.Response{Payload: []byte("ok")}, nil
}
func (forceMappingAliasChangeExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (forceMappingAliasChangeExecutor) Refresh(_ context.Context, auth *Auth) (*Auth, error) {
	return auth, nil
}
func (forceMappingAliasChangeExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestHomeRetainedRouteRewritesReasoningSuffixAndWaitsForReleaseACK(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "retained-route-ack",
		shinwayexecutor.PinnedAuthMetadataKey:       "retained-route-auth",
	}}
	for _, model := range []string{"alias-a", "alias-a(high)", "alias-a", "alias-a(custom)"} {
		response, errExecute := manager.Execute(ctx, []string{"retained-route"}, shinwayexecutor.Request{Model: model}, opts)
		if errExecute != nil {
			t.Fatalf("Execute(%q) error = %v", model, errExecute)
		}
...
func (e *retainedRouteModelExecutor) Execute(_ context.Context, _ *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.mu.Lock()
...
func (*retainedRouteModelExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*retainedRouteModelExecutor) Refresh(_ context.Context, auth *Auth) (*Auth, error) {
	return auth, nil
}
func (*retainedRouteModelExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestHomeRetainedPrefixedRouteRewritesSuffixAndResponse(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "prefixed-retained-route",
		shinwayexecutor.PinnedAuthMetadataKey:       "prefixed-retained-route-auth",
	}}
	for _, model := range []string{"team/alias-a", "team/alias-a(high)"} {
		response, errExecute := manager.Execute(ctx, []string{"prefixed-retained-route"}, shinwayexecutor.Request{Model: model}, opts)
		if errExecute != nil {
			t.Fatalf("Execute(%q) error = %v", model, errExecute)
		}
		if got := string(response.Payload); got != `{"model":"`+model+`"}` {
...
func (e *prefixedRetainedRouteExecutor) Execute(_ context.Context, _ *Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.mu.Lock()
	e.models = append(e.models, req.Model)
	e.mu.Unlock()
	if lifecycle, ok := opts.ExecutionLifecycle.(interface{ Retain() }); ok {
...
func (*prefixedRetainedRouteExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*prefixedRetainedRouteExecutor) Refresh(_ context.Context, auth *Auth) (*Auth, error) {
	return auth, nil
}
func (*prefixedRetainedRouteExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestHomeRedispatchStopsWhenReleaseAcknowledgementFails(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "release-failure",
		shinwayexecutor.PinnedAuthMetadataKey:       "retained-route-auth",
	}}
	if _, errExecute := manager.Execute(ctx, []string{"retained-route"}, shinwayexecutor.Request{Model: "alias-a"}, opts); errExecute != nil {
		t.Fatalf("first Execute() error = %v", errExecute)
	}
	if _, errExecute := manager.Execute(ctx, []string{"retained-route"}, shinwayexecutor.Request{Model: "alias-a(custom)"}, opts); errExecute == nil {
