...
func TestPickNextViaHomeDoesNotReusePinnedWebsocketAuthWithoutSelection(t *testing.T) {
	...
	opts := shinwayexecutor.Options{
		Metadata: map[string]any{
			...
			shinwayexecutor.PinnedAuthMetadataKey:       "home-auth-1",
		},
...
func TestPickNextViaHomeRejectsSessionScopedAuthCache(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	optsSession1 := shinwayexecutor.Options{
		Metadata: map[string]any{
			shinwayexecutor.ExecutionSessionMetadataKey: "session-1",
			shinwayexecutor.PinnedAuthMetadataKey:       "home-auth-1",
		},
	}
	optsSession2 := shinwayexecutor.Options{
		Metadata: map[string]any{
			shinwayexecutor.ExecutionSessionMetadataKey: "session-2",
			shinwayexecutor.PinnedAuthMetadataKey:       "home-auth-1",
		},
	}
...
func TestPickNextViaHomeDoesNotReusePinnedWebsocketAuthAfterFirstHomeAttempt(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	opts := withHomeAuthCount(shinwayexecutor.Options{
		Metadata: map[string]any{
			shinwayexecutor.ExecutionSessionMetadataKey: "session-1",
			shinwayexecutor.PinnedAuthMetadataKey:       "home-auth-1",
		},
