...
type homeExecutionStreamExecutor struct {
	chunks <-chan shinwayexecutor.StreamChunk
}
...
func (e *homeExecutionExecutor) Execute(ctx context.Context, _ *Auth, _ shinwayexecutor.Request, _ shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.ctx = ctx
	if errCtx := ctx.Err(); errCtx != nil {
		return shinwayexecutor.Response{}, errCtx
	}
	return shinwayexecutor.Response{Payload: []byte("ok")}, nil
}
func (*homeExecutionExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*homeExecutionExecutor) Refresh(context.Context, *Auth) (*Auth, error) { return nil, nil }
func (*homeExecutionExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
...
func (*homeExecutionStreamExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
func (e *homeExecutionStreamExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return &shinwayexecutor.StreamResult{Chunks: e.chunks}, nil
}
func (*homeExecutionStreamExecutor) Refresh(context.Context, *Auth) (*Auth, error) { return nil, nil }
func (*homeExecutionStreamExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestHomeSelectionEndsAfterExecute(t *testing.T) {
	...
	if _, errExecute := manager.Execute(context.Background(), []string{"home-execution"}, shinwayexecutor.Request{Model: "test"}, shinwayexecutor.Options{}); errExecute != nil {
	...
	tests := []struct {
	...
	}{
		{
			...
			run: func(manager *Manager, ctx context.Context) error {
				_, errExecute := manager.Execute(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, shinwayexecutor.Options{})
				return errExecute
			},
		},
		{
			name: "count_tokens",
			run: func(manager *Manager, ctx context.Context) error {
				_, errCount := manager.ExecuteCount(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, shinwayexecutor.Options{})
				return errCount
			},
		},
	}
...
func TestHomeStreamConsumerCancelEndsSelection(t *testing.T) {
	...
	chunks <- shinwayexecutor.StreamChunk{Payload: []byte("initial")}
	manager.RegisterExecutor(&homeExecutionStreamExecutor{chunks: chunks})

	result, errExecute := manager.ExecuteStream(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "test"}, shinwayexecutor.Options{Stream: true})
	if errExecute != nil {
...
func (e *retainingHomeExecutionExecutor) Execute(_ context.Context, _ *Auth, _ shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.calls.Add(1)
...
func (*retainingHomeExecutionExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*retainingHomeExecutionExecutor) Refresh(context.Context, *Auth) (*Auth, error) {
	return nil, nil
}
func (*retainingHomeExecutionExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestHomeWebsocketSessionReusesRetainedSelection(t *testing.T) {
	...
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "session-1",
		shinwayexecutor.PinnedAuthMetadataKey:       "home-auth",
	}}
	for range 2 {
		if _, errExecute := manager.Execute(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, opts); errExecute != nil {
			t.Fatalf("Execute() error = %v", errExecute)
		}
	}
...
func (e *selectionRecordingExecutor) Execute(_ context.Context, _ *Auth, _ shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
...
func (*selectionRecordingExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*selectionRecordingExecutor) Refresh(context.Context, *Auth) (*Auth, error) { return nil, nil }
func (*selectionRecordingExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestHomeWebsocketTargetChangeEndsSelectionBeforeRedispatch(t *testing.T) {
	...
	if _, errExecute := manager.Execute(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "model-b"}, opts); errExecute != nil {
...
func (e *bindingSelectionRecordingExecutor) Execute(_ context.Context, _ *Auth, _ shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	selection, _ := opts.ExecutionLifecycle.(*HomeDispatchSelection)
	if e.first == nil {
		e.first = selection
	}
...
func (*bindingSelectionRecordingExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*bindingSelectionRecordingExecutor) Refresh(context.Context, *Auth) (*Auth, error) {
	return nil, nil
}
func (*bindingSelectionRecordingExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func (*lifecycleRetryExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
func (e *lifecycleRetryExecutor) ExecuteStream(ctx context.Context, _ *Auth, _ shinwayexecutor.Request, opts shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	if e.calls.Add(1) == 1 {
...
func (*lifecycleRetryExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestHomeStreamLifecycleFailureEndsBeforeFreshDispatch(t *testing.T) {
	...
	opts := shinwayexecutor.Options{Stream: true, Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "session-426",
	}}
...
func TestHomeSelectionCancellationPreventsExecute(t *testing.T) {
	...
	ctx, cancel := context.WithCancel(context.Background())
	cancel()
	_, errExecute := manager.Execute(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "test"}, shinwayexecutor.Options{})
	if errExecute == nil {
...
func (*retryingHomeStreamExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
func (e *retryingHomeStreamExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	if e.calls.Add(1) == 1 {
		return nil, &Error{HTTPStatus: http.StatusUnauthorized, Message: "expired"}
	}
	chunks := make(chan shinwayexecutor.StreamChunk, 1)
	chunks <- shinwayexecutor.StreamChunk{Payload: []byte("data: {\"type\":\"response.completed\"}\n\n")}
	close(chunks)
	return &shinwayexecutor.StreamResult{Chunks: chunks}, nil
}
...
func (*retryingHomeStreamExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestHomeStreamRetryUsesFreshSelection(t *testing.T) {
	...
	result, errExecute := manager.ExecuteStream(context.Background(), []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, shinwayexecutor.Options{Stream: true})
	if errExecute != nil {
		t.Fatalf("ExecuteStream() error = %v", errExecute)
	}
	for range result.Chunks {
...
func (e *cancellationBarrierExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.executeCalls.Add(1)
	return shinwayexecutor.Response{}, nil
}
func (e *cancellationBarrierExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	e.countCalls.Add(1)
	return shinwayexecutor.Response{}, nil
}
func (e *cancellationBarrierExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	e.streamCalls.Add(1)
	return nil, nil
}
...
func TestHomeCancellationBarrierPreventsEveryExecutorInvocation(t *testing.T) {
	...
	if _, errExecute := manager.Execute(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "test"}, shinwayexecutor.Options{}); errExecute == nil {
		t.Fatal("Execute() error = nil, want canceled context")
	}
	if _, errCount := manager.ExecuteCount(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "test"}, shinwayexecutor.Options{}); errCount == nil {
		t.Fatal("ExecuteCount() error = nil, want canceled context")
	}
	if _, errStream := manager.ExecuteStream(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "test"}, shinwayexecutor.Options{Stream: true}); errStream == nil {
...
func TestHomeStreamEndsOnTerminalChunk(t *testing.T) {
	...
	result, errExecute := manager.ExecuteStream(context.Background(), []string{"home-execution"}, shinwayexecutor.Request{Model: "test"}, shinwayexecutor.Options{Stream: true})
	if errExecute != nil {
		t.Fatalf("ExecuteStream() error = %v", errExecute)
	}
...
func TestHomeWebsocketSessionReusesSelectionWithoutPinnedMetadataAndCachesRuntimeAuth(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "session-without-pin",
	}}
	for range 2 {
		if _, errExecute := manager.Execute(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, opts); errExecute != nil {
			t.Fatalf("Execute() error = %v", errExecute)
...
func TestCloseExecutionSessionReclaimsHomeSessionLock(t *testing.T) {
	...
	ctx := shinwayexecutor.WithDownstreamWebsocket(context.Background())
	opts := shinwayexecutor.Options{Metadata: map[string]any{
		shinwayexecutor.ExecutionSessionMetadataKey: "reclaim-lock",
	}}
...
func (e *homePerSelectionFailureExecutor) invoke(auth *Auth, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	selection, _ := opts.ExecutionLifecycle.(*HomeDispatchSelection)
	if e.selections == nil {
	...
	return shinwayexecutor.Response{}, &Error{HTTPStatus: http.StatusBadGateway, Message: "upstream failed"}
}
func (e *homePerSelectionFailureExecutor) Execute(_ context.Context, auth *Auth, _ shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return e.invoke(auth, opts)
}
func (*homePerSelectionFailureExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*homePerSelectionFailureExecutor) Refresh(context.Context, *Auth) (*Auth, error) {
	return nil, nil
}
func (e *homePerSelectionFailureExecutor) CountTokens(_ context.Context, auth *Auth, _ shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return e.invoke(auth, opts)
}
...
func TestHomeNonstreamAndCountUseOneModelPerSelection(t *testing.T) {
	for _, countTokens := range []bool{false, true} {
		t.Run(map[bool]string{false: "Execute", true: "CountTokens"}[countTokens], func(t *testing.T) {
			...
			if countTokens {
				_, errExecute = manager.ExecuteCount(context.Background(), []string{openAICompatPoolProviderKey}, shinwayexecutor.Request{Model: "requested"}, shinwayexecutor.Options{})
			} else {
				_, errExecute = manager.Execute(context.Background(), []string{openAICompatPoolProviderKey}, shinwayexecutor.Request{Model: "requested"}, shinwayexecutor.Options{})
			}
			if errExecute == nil {
...
func TestHomeStreamEndsOnErrorChunk(t *testing.T) {
	...
	registry := executionregistry.New()
	manager.PublishHomeDispatch(homeExecutionDispatcher{}, registry, 1)
	chunks := make(chan shinwayexecutor.StreamChunk, 2)
	chunks <- shinwayexecutor.StreamChunk{Payload: []byte("initial")}
	chunks <- shinwayexecutor.StreamChunk{Err: &Error{HTTPStatus: http.StatusBadGateway, Message: "upstream failed"}}
	close(chunks)
	manager.RegisterExecutor(&homeExecutionStreamExecutor{chunks: chunks})
...
func (*missingHomeStreamSourceExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
func (*missingHomeStreamSourceExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*missingHomeStreamSourceExecutor) Refresh(context.Context, *Auth) (*Auth, error) {
	return nil, nil
}
func (*missingHomeStreamSourceExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestAccountedHomeExecuteAndCountReleaseOnce(t *testing.T) {
	for _, countTokens := range []bool{false, true} {
		t.Run(map[bool]string{false: "Execute", true: "Count"}[countTokens], func(t *testing.T) {
			...
			var errExecute error
			if countTokens {
				_, errExecute = manager.ExecuteCount(context.Background(), []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, shinwayexecutor.Options{})
			} else {
				_, errExecute = manager.Execute(context.Background(), []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, shinwayexecutor.Options{})
			}
			if errExecute != nil {
...
func TestAccountedHomeStreamErrorDrainsUntilSourceClosesBeforeRelease(t *testing.T) {
	...
	go func() {
		chunks <- shinwayexecutor.StreamChunk{Payload: []byte("after-error-1")}
		chunks <- shinwayexecutor.StreamChunk{Payload: []byte("after-error-2")}
		close(sent)
	}()
	select {
	case <-sent:
...
func TestAccountedHomeStreamErrorCancellationReleasesSelection(t *testing.T) {
	...
	result, errExecute := manager.ExecuteStream(ctx, []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, shinwayexecutor.Options{Stream: true})
	if errExecute != nil {
		t.Fatalf("ExecuteStream() error = %v", errExecute)
	}
	if _, ok := <-result.Chunks; !ok {
...
func (e *retryingAccountedHomeExecutor) Execute(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	if e.calls.Add(1) == 1 {
		return shinwayexecutor.Response{}, &Error{HTTPStatus: http.StatusBadGateway, Message: "upstream failed"}
	}
	return shinwayexecutor.Response{Payload: []byte("ok")}, nil
}
func (*retryingAccountedHomeExecutor) ExecuteStream(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	return nil, nil
}
func (*retryingAccountedHomeExecutor) Refresh(context.Context, *Auth) (*Auth, error) { return nil, nil }
func (*retryingAccountedHomeExecutor) CountTokens(context.Context, *Auth, shinwayexecutor.Request, shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	return shinwayexecutor.Response{}, nil
}
...
func TestAccountedHomeRetrySelectsAndReleasesEveryAttempt(t *testing.T) {
	...
	if _, errExecute := manager.Execute(context.Background(), []string{"home-execution"}, shinwayexecutor.Request{Model: "model-a"}, shinwayexecutor.Options{}); errExecute != nil {
		t.Fatalf("Execute() error = %v", errExecute)
	}
	if got := dispatcher.calls.Load(); got != 2 {
