...
func TestInstallUsesLatestReleaseVersion(t *testing.T) {
	...
	client := Client{HTTPClient: mapHTTPDoer{
		"https://api.github.com/repos/author-name/shinway-sample-provider-plugin/releases/latest": []byte(`{
			"tag_name": "v0.2.0",
			"assets": [
				{
					"name": "` + archiveName + `",
					"url": "https://api.github.com/repos/author-name/shinway-sample-provider-plugin/releases/assets/1",
					"browser_download_url": "https://downloads.example/` + archiveName + `"
				},
				{
					"name": "checksums.txt",
					"url": "https://api.github.com/repos/author-name/shinway-sample-provider-plugin/releases/assets/2",
...
func TestDownloadAssetFallsBackToReleaseAssetAPIURLWhenBrowserDownloadURLEmpty(t *testing.T) {
	apiURL := "https://api.github.com/repos/author-name/shinway-sample-provider-plugin/releases/assets/1"
	client := Client{HTTPClient: mapHTTPDoer{
...
func TestDownloadAssetUsesAPIURLWhenAuthMatchesArtifact(t *testing.T) {
	...
	client := Client{
		...
		Auth: []AuthConfig{{
			Match:    "https://api.github.com/repos/author-name/shinway-sample-provider-plugin/releases/",
...
func TestInstallVersionUsesPinnedReleaseTag(t *testing.T) {
	...
	checksum := sha256.Sum256(archiveData)
	client := Client{HTTPClient: mapHTTPDoer{
		"https://api.github.com/repos/author-name/shinway-sample-provider-plugin/releases/tags/v0.3.0": []byte(`{
			"tag_name": "v0.3.0",
			"assets": [
...
func TestInstallRejectsInvalidLatestReleaseTag(t *testing.T) {
	...
	client := Client{HTTPClient: mapHTTPDoer{
		"https://api.github.com/repos/author-name/shinway-sample-provider-plugin/releases/latest": []byte(`{"tag_name": "latest", "assets": []}`),
	}}
...
func testPlugin() Plugin {
	return Plugin{
		...
		Author:      "author-name",
		Version:     "0.1.0",
		Repository:  "https://github.com/author-name/shinway-sample-provider-plugin",
	}
}
