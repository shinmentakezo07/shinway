...
import (
	...
	xaiauth "github.com/shinmentakezo07/shinway/v7/internal/auth/xai"
...
func (e *XAIWebsocketsExecutor) Execute(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	if e == nil || e.XAIExecutor == nil {
		return shinwayexecutor.Response{}, fmt.Errorf("xai websockets executor: executor is nil")
	}
	return e.XAIExecutor.Execute(ctx, auth, req, opts)
}

func (e *XAIWebsocketsExecutor) ExecuteStream(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (_ *shinwayexecutor.StreamResult, err error) {
	if e == nil || e.XAIExecutor == nil {
	...
	go func() {
		...
		send := func(chunk shinwayexecutor.StreamChunk) bool {
			if ctx == nil {
				out <- chunk
				return true
			}
		...
		for {
			if ctx != nil && ctx.Err() != nil {
				...
				_ = send(shinwayexecutor.StreamChunk{Err: ctx.Err()})
				return
			}
			...
			if errRead != nil {
				...
				_ = send(shinwayexecutor.StreamChunk{Err: mappedErr})
				return
			}
			if msgType != websocket.TextMessage {
				if msgType == websocket.BinaryMessage {
					...
					_ = send(shinwayexecutor.StreamChunk{Err: errBinary})
					return
				}
				continue
			}
			...
			if wsErr, ok := parseXAIWebsocketError(payload); ok {
				...
				_ = send(shinwayexecutor.StreamChunk{Err: wsErr})
				return
			}
			...
			for _, payload := range xaiNormalizeReasoningSummaryDataEvents(payload) {
				...
				if shinwayexecutor.DownstreamWebsocket(ctx) {
					...
					if !send(shinwayexecutor.StreamChunk{Payload: downstreamPayload}) {
						terminateReason = "context_done"
						terminateErr = ctx.Err()
						return
					}
					if len(downstreamWarmupCompletedPayload) > 0 {
						if !send(shinwayexecutor.StreamChunk{Payload: downstreamWarmupCompletedPayload}) {
							terminateReason = "context_done"
							terminateErr = ctx.Err()
							return
						}
				...
				for i := range chunks {
					if !send(shinwayexecutor.StreamChunk{Payload: chunks[i]}) {
						terminateReason = "context_done"
						terminateErr = ctx.Err()
						return
					}
	...
	return &shinwayexecutor.StreamResult{Headers: upstreamHeaders, Chunks: out}, nil
}

func (e *XAIWebsocketsExecutor) executeCompactionTriggerFromWebsocketContext(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options, idMapper *xaiWebsocketRequestIDMapper) (*shinwayexecutor.StreamResult, error) {
	...
	out := make(chan shinwayexecutor.StreamChunk, len(chunks))
	for _, chunk := range chunks {
		out <- shinwayexecutor.StreamChunk{Payload: chunk}
	}
	close(out)
	return &shinwayexecutor.StreamResult{Headers: headers, Chunks: out}, nil
}
...
func (e *XAIWebsocketsExecutor) prepareResponsesWebsocketRequest(ctx context.Context, req shinwayexecutor.Request, opts shinwayexecutor.Options) (*xaiPreparedRequest, error) {
...
func (e *XAIWebsocketsExecutor) dialXAIWebsocket(ctx context.Context, auth *shinwayauth.Auth, wsURL string, headers http.Header) (*websocket.Conn, *websocketConnectionCloser, *http.Response, error) {
...
func (e *XAIWebsocketsExecutor) ensureUpstreamConn(ctx context.Context, auth *shinwayauth.Auth, sess *codexWebsocketSession, authID string, wsURL string, headers http.Header) (*websocket.Conn, *websocketConnectionCloser, *http.Response, error) {
	if sess == nil {
...
func (e *XAIWebsocketsExecutor) CloseExecutionSession(sessionID string) {
	...
	if sessionID == shinwayauth.CloseAllExecutionSessionsID {
...
func applyXAIWebsocketHeaders(headers http.Header, auth *shinwayauth.Auth, token string, sessionID string) http.Header {
	if headers == nil {
		headers = http.Header{}
	}
...
func (e *XAIAutoExecutor) PrepareRequest(req *http.Request, auth *shinwayauth.Auth) error {
...
func (e *XAIAutoExecutor) HttpRequest(ctx context.Context, auth *shinwayauth.Auth, req *http.Request) (*http.Response, error) {
	if e == nil || e.httpExec == nil {
...
func (e *XAIAutoExecutor) Execute(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	if e == nil || e.httpExec == nil {
		return shinwayexecutor.Response{}, fmt.Errorf("xai auto executor: executor is nil")
	}
	return e.httpExec.Execute(ctx, auth, req, opts)
}

func (e *XAIAutoExecutor) ExecuteStream(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (*shinwayexecutor.StreamResult, error) {
	if e == nil || e.httpExec == nil || e.wsExec == nil {
		return nil, fmt.Errorf("xai auto executor: executor is nil")
	}
	if shinwayexecutor.DownstreamWebsocket(ctx) && xaiWebsocketsEnabled(auth) {
...
func (e *XAIAutoExecutor) Refresh(ctx context.Context, auth *shinwayauth.Auth) (*shinwayauth.Auth, error) {
	if e == nil || e.httpExec == nil {
		return nil, fmt.Errorf("xai auto executor: http executor is nil")
	}
...
func (e *XAIAutoExecutor) CountTokens(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	if e == nil || e.httpExec == nil {
		return shinwayexecutor.Response{}, fmt.Errorf("xai auto executor: http executor is nil")
	}
...
func xaiWebsocketsEnabled(auth *shinwayauth.Auth) bool {
	if auth == nil {
		return false
	}
