...
import (
	...
	claudeauth "github.com/shinmentakezo07/shinway/v7/internal/auth/claude"
...
func (e *ClaudeExecutor) Refresh(ctx context.Context, auth *shinwayauth.Auth) (*shinwayauth.Auth, error) {
