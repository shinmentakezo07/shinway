...
import (
	...
	multiagentv2 "github.com/shinmentakezo07/shinway/v7/internal/client/codex/optimize-multi-agent-v2"
	"github.com/shinmentakezo07/shinway/v7/internal/config"
	"github.com/shinmentakezo07/shinway/v7/internal/thinking"
	openaichatclaude "github.com/shinmentakezo07/shinway/v7/internal/translator/claude/openai/chat-completions"
	responsesclaude "github.com/shinmentakezo07/shinway/v7/internal/translator/claude/openai/responses"
	codexclaude "github.com/shinmentakezo07/shinway/v7/internal/translator/codex/claude"
	geminiclaude "github.com/shinmentakezo07/shinway/v7/internal/translator/gemini/claude"
	interactionsclaude "github.com/shinmentakezo07/shinway/v7/internal/translator/interactions/claude"
	openaiclaude "github.com/shinmentakezo07/shinway/v7/internal/translator/openai/claude"
...
func OptimizeCodexMultiAgentV2RequestForAuth(ctx context.Context, headers http.Header, payload []byte, cfg *config.Config, auth *shinwayauth.Auth, model string) ([]byte, bool) {
	updated, optimized := multiagentv2.OptimizeCodexMultiAgentV2Request(ctx, headers, payload, cfg)
	if shinwayauth.CodexAPIKeyModelIsCompat(cfg, auth, model) {
