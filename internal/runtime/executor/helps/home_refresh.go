...
func RefreshAuthViaHome(ctx context.Context, cfg *config.Config, auth *shinwayauth.Auth) (*shinwayauth.Auth, bool, error) {
...
func parseHomeRefreshAuth(raw []byte) (*shinwayauth.Auth, string, error) {
