...
func (e *CodexWebsocketsExecutor) dialCodexWebsocket(ctx context.Context, auth *shinwayauth.Auth, wsURL string, headers http.Header) (*websocket.Conn, *websocketConnectionCloser, *http.Response, error) {
...
func shouldRetryCodexWebsocketSend(err error) bool {
	...
	var requestErr shinwayexecutor.RequestScopedError
...
func newProxyAwareWebsocketDialer(cfg *config.Config, auth *shinwayauth.Auth) *websocket.Dialer {
