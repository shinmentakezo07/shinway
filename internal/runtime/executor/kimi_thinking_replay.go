...
func kimiThinkingReplayScopeFromRequest(ctx context.Context, req shinwayexecutor.Request, opts shinwayexecutor.Options) kimiThinkingReplayScope {
...
func prepareKimiThinkingReplayRequest(ctx context.Context, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Request, kimiThinkingReplayScope) {
...
func wrapThinkingReplayStream(ctx context.Context, result *shinwayexecutor.StreamResult, scope kimiThinkingReplayScope, cacheContent thinkingReplayContentCacheFunc, clearContent thinkingReplayContentClearFunc) *shinwayexecutor.StreamResult {
	...
	return &shinwayexecutor.StreamResult{Headers: result.Headers.Clone(), Chunks: out}
}

func wrapKimiThinkingReplayStream(ctx context.Context, result *shinwayexecutor.StreamResult, scope kimiThinkingReplayScope) *shinwayexecutor.StreamResult {
