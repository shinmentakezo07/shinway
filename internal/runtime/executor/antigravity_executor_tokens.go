...
func (e *AntigravityExecutor) CountTokens(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	...
	if errToken != nil {
		return shinwayexecutor.Response{}, errToken
	}
	if updatedAuth != nil {
		auth = updatedAuth
	}
	if strings.TrimSpace(token) == "" {
		return shinwayexecutor.Response{}, statusErr{code: http.StatusUnauthorized, msg: "missing access token"}
	}
	...
	if errReplay != nil {
		return shinwayexecutor.Response{}, errReplay
	}
	...
	for idx, baseURL := range baseURLs {
		...
		if errReq != nil {
			return shinwayexecutor.Response{}, errReq
		}
		httpReq.Close = true
		...
		if httpResp.StatusCode >= http.StatusOK && httpResp.StatusCode < http.StatusMultipleChoices {
			...
			return shinwayexecutor.Response{Payload: translated, Headers: httpResp.Header.Clone()}, nil
		}
		...
		return shinwayexecutor.Response{}, sErr
	}
	...
	default:
		return shinwayexecutor.Response{}, statusErr{code: http.StatusServiceUnavailable, msg: "antigravity executor: no base url available"}
	}
}
