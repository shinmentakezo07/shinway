...
import (
	...
	"github.com/shinmentakezo07/shinway/v7/internal/signature"
...
func applyCodexReasoningReplayCache(ctx context.Context, from sdktranslator.Format, req shinwayexecutor.Request, opts shinwayexecutor.Options, body []byte) ([]byte, codexReasoningReplayScope) {
	updated, scope, _ := applyCodexReasoningReplayCacheRequired(ctx, from, req, opts, body)
	return updated, scope
}

func applyCodexReasoningReplayCacheRequired(ctx context.Context, from sdktranslator.Format, req shinwayexecutor.Request, opts shinwayexecutor.Options, body []byte) ([]byte, codexReasoningReplayScope, error) {
...
func codexReasoningReplayScopeFromRequest(ctx context.Context, from sdktranslator.Format, req shinwayexecutor.Request, opts shinwayexecutor.Options, body []byte) codexReasoningReplayScope {
...
func codexReasoningReplaySessionKey(ctx context.Context, from sdktranslator.Format, req shinwayexecutor.Request, opts shinwayexecutor.Options, body []byte) string {
	if ctx == nil {
