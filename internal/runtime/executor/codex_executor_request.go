...
func (e *CodexExecutor) PrepareRequest(req *http.Request, auth *shinwayauth.Auth) error {
	if req == nil {
		return nil
	}
...
func (e *CodexExecutor) HttpRequest(ctx context.Context, auth *shinwayauth.Auth, req *http.Request) (*http.Response, error) {
	if req == nil {
...
func (e *CodexExecutor) cacheHelper(ctx context.Context, from sdktranslator.Format, url string, auth *shinwayauth.Auth, req shinwayexecutor.Request, userPayload []byte, rawJSON []byte, headerSets ...http.Header) (*http.Request, []byte, codexIdentityConfuseState, error) {
...
func applyCodexIdentityConfuseBody(cfg *config.Config, auth *shinwayauth.Auth, userPayload []byte, rawJSON []byte) ([]byte, codexIdentityConfuseState) {
...
func applyCodexHeaders(r *http.Request, auth *shinwayauth.Auth, token string, stream bool, cfg *config.Config) {
...
func applyCodexDirectImageHeaders(r *http.Request, auth *shinwayauth.Auth, token string, stream bool, cfg *config.Config) {
	var ginHeaders http.Header
	if ginCtx, ok := r.Context().Value("gin").(*gin.Context); ok && ginCtx != nil && ginCtx.Request != nil {
...
func applyCodexHeadersFromSources(r *http.Request, auth *shinwayauth.Auth, token string, stream bool, cfg *config.Config, ginHeaders http.Header) {
...
func isCodexFreePlanAuth(auth *shinwayauth.Auth) bool {
	if auth == nil || auth.Attributes == nil {
		return false
	}
...
func ensureImageGenerationTool(body []byte, baseModel string, auth *shinwayauth.Auth, headers http.Header) []byte {
