...
func antigravityReasoningReplayScopeFromRequest(ctx context.Context, modelName string, req shinwayexecutor.Request, opts shinwayexecutor.Options, payload []byte) antigravityReasoningReplayScope {
...
func antigravityReasoningReplayClientSessionKey(ctx context.Context, req shinwayexecutor.Request, opts shinwayexecutor.Options) string {
	...
	if value := metadataString(opts.Metadata, shinwayexecutor.ExecutionSessionMetadataKey); value != "" {
		return "execution:" + value
	}
	if value := metadataString(req.Metadata, shinwayexecutor.ExecutionSessionMetadataKey); value != "" {
		return "execution:" + value
	}
	for _, raw := range [][]byte{opts.OriginalRequest, req.Payload} {
...
func prepareAntigravityGeminiReasoningReplayPayload(ctx context.Context, modelName string, req shinwayexecutor.Request, opts shinwayexecutor.Options, payload []byte) ([]byte, antigravityReasoningReplayScope, error) {
...
func applyAntigravityReasoningReplayCache(ctx context.Context, modelName string, req shinwayexecutor.Request, opts shinwayexecutor.Options, payload []byte) ([]byte, antigravityReasoningReplayScope, bool, error) {
