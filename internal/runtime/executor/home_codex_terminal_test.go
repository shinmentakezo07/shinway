...
func TestHomeCodexTerminalStreamFailureUsesFreshDispatchOnNextRequest(t *testing.T) {
	...
	dispatcher := &terminalCodexHomeDispatcher{auth: shinwayauth.Auth{
		ID:       "home-codex",
		Provider: "codex",
	...
	opts := shinwayexecutor.Options{
		...
		Metadata: map[string]any{
			shinwayexecutor.ExecutionSessionMetadataKey: "terminal-home-session",
		},
	}
	request := shinwayexecutor.Request{Model: "gpt-5-codex", Payload: []byte(`{"model":"gpt-5-codex","input":[]}`)}
