...
func newCodexOpenAIImageTestAuth(serverURL string) *shinwayauth.Auth {
...
func codexOpenAIImageTestOptions(path string, stream bool) shinwayexecutor.Options {
	return shinwayexecutor.Options{
		SourceFormat: sdktranslator.FromString(codexOpenAIImageSourceFormat),
		Stream:       stream,
		Metadata: map[string]any{
			shinwayexecutor.RequestPathMetadataKey: path,
		},
	}
}
...
func TestCodexExecutorDirectOpenAIImageGenerationUsesImagesEndpoint(t *testing.T) {
	...
	resp, errExecute := executor.Execute(ctx, newCodexOpenAIImageTestAuth(server.URL), shinwayexecutor.Request{
...
func TestCodexExecutorDirectOpenAIImageGenerationStreamsImagesEndpoint(t *testing.T) {
	...
	executor := NewCodexExecutor(&config.Config{})
	stream, errStream := executor.ExecuteStream(context.Background(), newCodexOpenAIImageTestAuth(server.URL), shinwayexecutor.Request{
		Model:   "gpt-image-2",
...
func TestCodexExecutorDirectOpenAIImageEditUsesImagesEditEndpointForJSON(t *testing.T) {
	...
	executor := NewCodexExecutor(&config.Config{})
	_, errExecute := executor.Execute(context.Background(), newCodexOpenAIImageTestAuth(server.URL), shinwayexecutor.Request{
		Model:   "gpt-image-2",
