...
import (
	...
	"github.com/shinmentakezo07/shinway/v7/internal/cache"
	...
	antigravityclaude "github.com/shinmentakezo07/shinway/v7/internal/translator/antigravity/claude"
...
func newAntigravityHTTPClient(ctx context.Context, cfg *config.Config, auth *shinwayauth.Auth, timeout time.Duration) *http.Client {
...
func (e *AntigravityExecutor) resolveWebSearchGroundingURLs(ctx context.Context, auth *shinwayauth.Auth, from sdktranslator.Format, originalRequestRawJSON, requestRawJSON, responseRawJSON []byte) []byte {
...
func (e *AntigravityExecutor) PrepareRequest(req *http.Request, auth *shinwayauth.Auth) error {
	if req == nil {
		return nil
	}
...
func (e *AntigravityExecutor) HttpRequest(ctx context.Context, auth *shinwayauth.Auth, req *http.Request) (*http.Response, error) {
	if req == nil {
