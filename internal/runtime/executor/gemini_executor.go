...
func (e *GeminiExecutor) RequestToFormat(req shinwayexecutor.Request, opts shinwayexecutor.Options) sdktranslator.Format {
...
func (e *GeminiExecutor) PrepareRequest(req *http.Request, auth *shinwayauth.Auth) error {
	if req == nil {
		return nil
	}
...
func (e *GeminiExecutor) HttpRequest(ctx context.Context, auth *shinwayauth.Auth, req *http.Request) (*http.Response, error) {
	if req == nil {
...
//
// Returns:
//   - shinwayexecutor.Response: The response from the API
//   - error: An error if the request fails
func (e *GeminiExecutor) Execute(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (resp shinwayexecutor.Response, err error) {
...
func (e *GeminiExecutor) ExecuteStream(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (_ *shinwayexecutor.StreamResult, err error) {
	if opts.Alt == "responses/compact" {
...
func (e *GeminiExecutor) executeInteractions(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (resp shinwayexecutor.Response, err error) {
	...
	var param any
	out := sdktranslator.TranslateNonStream(ctx, sdktranslator.FormatInteractions, shinwayexecutor.ResponseFormatOrSource(opts), req.Model, opts.OriginalRequest, body, data, &param)
	return shinwayexecutor.Response{Payload: out, Headers: httpResp.Header.Clone()}, nil
}

func (e *GeminiExecutor) executeInteractionsStream(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (_ *shinwayexecutor.StreamResult, err error) {
	targetName := thinking.ParseSuffix(req.Model).ModelName
	apiKey := geminiAPIKey(auth)
	reporter := helps.NewExecutorUsageReporter(ctx, e, targetName, auth)
	defer reporter.TrackFailure(ctx, &err)
	...
	go func() {
		...
		emitFrame := func() bool {
			...
			if responseFormat == sdktranslator.FormatInteractions {
				...
				select {
				case out <- shinwayexecutor.StreamChunk{Payload: visibleFrame}:
				case <-ctx.Done():
					return false
				}
				return true
...
func (e *GeminiExecutor) CountTokens(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	baseModel := thinking.ParseSuffix(req.Model).ModelName
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		return shinwayexecutor.Response{}, statusErr{code: resp.StatusCode, msg: string(data)}
	}

	count := gjson.GetBytes(data, "totalTokens").Int()
	translated := sdktranslator.TranslateTokenCount(respCtx, to, responseFormat, count, data)
	return shinwayexecutor.Response{Payload: translated, Headers: resp.Header.Clone()}, nil
}

// Refresh refreshes the authentication credentials (no-op for Gemini API key).
func (e *GeminiExecutor) Refresh(ctx context.Context, auth *shinwayauth.Auth) (*shinwayauth.Auth, error) {
...
func geminiAPIKey(a *shinwayauth.Auth) string {
	if a == nil {
		return ""
	}
	if a.Attributes != nil {
...
func resolveGeminiBaseURL(auth *shinwayauth.Auth) string {
	base := glEndpoint
...
func (e *GeminiExecutor) resolveGeminiConfig(auth *shinwayauth.Auth) *config.GeminiKey {
...
func shouldExecuteNativeInteractions(auth *shinwayauth.Auth, opts shinwayexecutor.Options) bool {
...
func translateGeminiInteractionsRequestBody(ctx context.Context, cfg *config.Config, model string, payload []byte, opts shinwayexecutor.Options, stream, isCompat bool) []byte {
...
func geminiInteractionsPayloadConfigSource(ctx context.Context, cfg *config.Config, model string, payload []byte, opts shinwayexecutor.Options, stream, isCompat bool) []byte {
...
func isNativeInteractionsAuth(auth *shinwayauth.Auth) bool {
	if auth == nil {
		return false
	}
...
func geminiAuthLogFields(auth *shinwayauth.Auth) (string, string, string, string) {
	if auth == nil {
		return "", "", "", ""
	}
	authType, authValue := auth.AccountInfo()
...
func applyGeminiHeaders(req *http.Request, auth *shinwayauth.Auth) {
