...
func translateGeminiInteractionsRequestBody(ctx context.Context, cfg *config.Config, model string, payload []byte, opts shinwayexecutor.Options, stream bool) []byte {
...
func geminiInteractionsPayloadConfigSource(ctx context.Context, cfg *config.Config, model string, payload []byte, opts shinwayexecutor.Options, stream bool) []byte {
