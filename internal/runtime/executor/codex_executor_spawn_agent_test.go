...
func TestCodexExecutorOptimizeMultiAgentV2(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := shinwayexecutor.Request{Model: "gpt-5.4", Payload: payload}
			opts := shinwayexecutor.Options{SourceFormat: sdktranslator.FromString("openai-response"), Headers: headers}
