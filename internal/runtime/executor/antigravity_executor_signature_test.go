...
func testAntigravityAuth(baseURL string) *shinwayauth.Auth {
...
func TestAntigravityExecutorCountTokensSanitizesGeminiToolHistory(t *testing.T) {
	...
	_, errCount := exec.CountTokens(context.Background(), testAntigravityAuth(server.URL), shinwayexecutor.Request{
