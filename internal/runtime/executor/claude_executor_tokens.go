...
func (e *ClaudeExecutor) CountTokens(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	...
	if err != nil {
		return shinwayexecutor.Response{}, fmt.Errorf("claude executor: token counting failed: %w", err)
	}
	...
	return shinwayexecutor.Response{Payload: out}, nil
}
...
func (e *ClaudeExecutor) countTokensUpstream(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	baseModel := thinking.ParseSuffix(req.Model).ModelName
	...
	if errHeaders := applyClaudeHeaders(httpReq, auth, apiKey, false, extraBetas, e.cfg, opts.Headers); errHeaders != nil {
		return shinwayexecutor.Response{}, errHeaders
	}
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		if decErr != nil {
			...
			return shinwayexecutor.Response{}, statusErr{code: resp.StatusCode, msg: msg}
		}
		...
		return shinwayexecutor.Response{}, statusErr{code: resp.StatusCode, msg: string(b)}
	}
	...
	return shinwayexecutor.Response{Payload: out, Headers: resp.Header.Clone()}, nil
}
