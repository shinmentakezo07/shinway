...
func (e *CodexWebsocketsExecutor) Execute(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (resp shinwayexecutor.Response, err error) {
	if ctx == nil {
	...
	if shinwayexecutor.RequiredUpstreamWebsocket(ctx) {
		...
		if conn == nil {
			return resp, shinwayexecutor.NewUpstreamWebsocketReplayRequiredError()
		}
	} else {
	...
	for {
		...
		case "response.completed":
			...
			resp = shinwayexecutor.Response{Payload: out}
			return resp, nil
		}
	}
}
