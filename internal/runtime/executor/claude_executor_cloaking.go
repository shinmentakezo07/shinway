...
func getCloakConfigFromAuth(auth *shinwayauth.Auth) (cloakMode string, strictMode bool, sensitiveWords []string, cacheUserID bool) {
	if auth == nil {
...
func applyCloaking(ctx context.Context, cfg *config.Config, auth *shinwayauth.Auth, payload []byte, model string, apiKey string) ([]byte, error) {
