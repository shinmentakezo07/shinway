...
func TestCodexExecutorReasoningReplayCacheSharesSameSessionAcrossClientKeys(t *testing.T) {
	...
	opts := shinwayexecutor.Options{SourceFormat: from}
...
func TestCodexExecutorReasoningReplaySessionKeyUsesClaudeCodeJSONSessionID(t *testing.T) {
	...
	got := codexReasoningReplaySessionKey(context.Background(), from, req, shinwayexecutor.Options{SourceFormat: from}, body)
...
func TestCodexExecutorReasoningReplaySessionKeyIsolatesClaudeCodeAgents(t *testing.T) {
	...
	metadata := map[string]any{shinwayexecutor.ExecutionSessionMetadataKey: "shared-execution-session"}
	root := codexReasoningReplayScopeFromRequest(context.Background(), from, req, shinwayexecutor.Options{SourceFormat: from, Headers: rootHeaders, Metadata: metadata}, body)
	childA := codexReasoningReplayScopeFromRequest(context.Background(), from, req, shinwayexecutor.Options{SourceFormat: from, Headers: childAHeaders, Metadata: metadata}, body)
	childB := codexReasoningReplayScopeFromRequest(context.Background(), from, req, shinwayexecutor.Options{SourceFormat: from, Headers: childBHeaders, Metadata: metadata}, body)
...
func TestCodexExecutorReasoningReplayCacheSharesSameSessionAcrossCodexAuths(t *testing.T) {
	...
	_, err := executor.Execute(context.Background(), firstAuth, shinwayexecutor.Request{
		Model:   "gpt-5.4",
	...
	_, err = executor.Execute(context.Background(), secondAuth, shinwayexecutor.Request{
		Model:   "gpt-5.4",
...
func TestCodexExecutorReasoningReplayCacheDoesNotInjectNativeResponsesRequest(t *testing.T) {
	...
	executor := NewCodexExecutor(&config.Config{})
	_, err := executor.Execute(context.Background(), &shinwayauth.Auth{
...
func TestCodexExecutorReasoningReplayCacheExecuteStreamStoresFinalDoneForClaude(t *testing.T) {
	...
	streamResult, err := executor.ExecuteStream(context.Background(), auth, shinwayexecutor.Request{
		Model:   "gpt-5.4",
...
func TestCodexExecutorReasoningReplayCacheClearsOnStreamResponseFailedInvalidSignature(t *testing.T) {
	...
	executor := NewCodexExecutor(&config.Config{})
	streamResult, err := executor.ExecuteStream(context.Background(), &shinwayauth.Auth{
...
func TestCodexExecutorReasoningReplayCacheRestoresCumulativeToolTurns(t *testing.T) {
	...
	updated, gotScope := applyCodexReasoningReplayCache(context.Background(), sdktranslator.FromString("claude"), req, shinwayexecutor.Options{SourceFormat: sdktranslator.FromString("claude")}, body)
...
func TestCodexExecutorReasoningReplayCacheSkipsDetachedTurnAfterCompaction(t *testing.T) {
	...
	updated, _ := applyCodexReasoningReplayCache(context.Background(), sdktranslator.FromString("claude"), req, shinwayexecutor.Options{SourceFormat: sdktranslator.FromString("claude")}, body)
	gotItems := gjson.GetBytes(updated, "input").Array()
...
func TestCodexExecutorReasoningReplayCacheDropsFunctionCallWithoutMatchingOutput(t *testing.T) {
	...
	updated, replayScope := applyCodexReasoningReplayCache(
		...
		req,
		shinwayexecutor.Options{SourceFormat: sdktranslator.FromString("claude")},
		body,
	)
