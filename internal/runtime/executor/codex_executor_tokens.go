...
func (e *CodexExecutor) CountTokens(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (shinwayexecutor.Response, error) {
	...
	if err != nil {
		return shinwayexecutor.Response{}, fmt.Errorf("codex executor: tokenizer init failed: %w", err)
	}

	count, err := countCodexInputTokens(enc, body)
	if err != nil {
		return shinwayexecutor.Response{}, fmt.Errorf("codex executor: token counting failed: %w", err)
	}
