...
func (e *AntigravityExecutor) Refresh(ctx context.Context, auth *shinwayauth.Auth) (*shinwayauth.Auth, error) {
...
func (e *AntigravityExecutor) ShouldPrepareRequestAuth(auth *shinwayauth.Auth) bool {
	return antigravityProjectIDFromAuth(auth) == ""
}

func (e *AntigravityExecutor) PrepareRequestAuth(ctx context.Context, auth *shinwayauth.Auth) (*shinwayauth.Auth, error) {
...
func (e *AntigravityExecutor) ensureAccessToken(ctx context.Context, auth *shinwayauth.Auth) (string, *shinwayauth.Auth, error) {
	if auth == nil {
...
func (e *AntigravityExecutor) refreshToken(ctx context.Context, auth *shinwayauth.Auth) (*shinwayauth.Auth, error) {
	if auth == nil {
		return nil, statusErr{code: http.StatusUnauthorized, msg: "missing auth"}
	}
...
func (e *AntigravityExecutor) refreshTokenSingleFlight(ctx context.Context, auth *shinwayauth.Auth, refreshToken string) (*antigravityTokenRefreshData, error) {
	form := url.Values{}
...
func (e *AntigravityExecutor) ensureAntigravityProjectID(ctx context.Context, auth *shinwayauth.Auth, accessToken string) error {
	if auth == nil {
		return nil
	}
...
func (e *AntigravityExecutor) fetchAntigravityProjectID(ctx context.Context, auth *shinwayauth.Auth, accessToken string) (string, error) {
...
func (e *AntigravityExecutor) projectIDForRequest(_ context.Context, auth *shinwayauth.Auth, _ string) (string, error) {
...
func antigravityProjectIDFromAuth(auth *shinwayauth.Auth) string {
