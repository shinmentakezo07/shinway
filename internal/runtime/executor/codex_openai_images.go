...
func isCodexOpenAIImageRequest(opts shinwayexecutor.Options) bool {
...
func (e *CodexExecutor) executeOpenAIImage(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (resp shinwayexecutor.Response, err error) {
...
func (e *CodexExecutor) executeOpenAIImageStream(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options) (_ *shinwayexecutor.StreamResult, err error) {
	if directEndpoint := codexDirectOpenAIImageEndpoint(req, opts); directEndpoint != "" {
	...
	go func() {
		...
		sendPayload := func(payload []byte) bool {
			select {
			case out <- shinwayexecutor.StreamChunk{Payload: payload}:
				return true
			case <-ctx.Done():
				return false
			}
		...
		sendError := func(errSend error) bool {
			select {
			case out <- shinwayexecutor.StreamChunk{Err: errSend}:
				return true
			case <-ctx.Done():
				return false
			}
...
func (e *CodexExecutor) executeDirectOpenAIImage(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options, endpointPath string) (resp shinwayexecutor.Response, err error) {
	...
	return shinwayexecutor.Response{Payload: data, Headers: httpResp.Header.Clone()}, nil
}

func (e *CodexExecutor) executeDirectOpenAIImageStream(ctx context.Context, auth *shinwayauth.Auth, req shinwayexecutor.Request, opts shinwayexecutor.Options, endpointPath string) (_ *shinwayexecutor.StreamResult, err error) {
	...
	go func() {
		...
		for {
			...
			if n > 0 {
				...
				select {
				case out <- shinwayexecutor.StreamChunk{Payload: chunk}:
				case <-ctx.Done():
					return
				}
			}
			if errRead != nil {
				if errRead != io.EOF {
					...
					select {
					case out <- shinwayexecutor.StreamChunk{Err: errRead}:
					case <-ctx.Done():
					}
				}
				return
...
func codexDirectOpenAIImageEndpoint(req shinwayexecutor.Request, opts shinwayexecutor.Options) string {
...
func codexPrepareDirectOpenAIImageBody(req shinwayexecutor.Request, opts shinwayexecutor.Options, stream bool) ([]byte, string, string, error) {
...
func codexPrepareDirectOpenAIImagePayload(req shinwayexecutor.Request, opts shinwayexecutor.Options, model string, stream bool) ([]byte, string, error) {
...
func codexDirectOpenAIImageModel(req shinwayexecutor.Request) string {
...
func (e *CodexExecutor) prepareCodexOpenAIImageBody(body []byte, req shinwayexecutor.Request, opts shinwayexecutor.Options, mainModel string) ([]byte, error) {
	out := body
...
func recordCodexOpenAIImageRequest(ctx context.Context, cfg *config.Config, provider string, auth *shinwayauth.Auth, url string, headers http.Header, body []byte) {
...
func codexPrepareOpenAIImageRequest(req shinwayexecutor.Request, opts shinwayexecutor.Options) (codexOpenAIImagePreparedRequest, error) {
	path := helps.PayloadRequestPath(opts)
