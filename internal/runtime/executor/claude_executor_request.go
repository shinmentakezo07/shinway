...
func applyClaudeHeaders(r *http.Request, auth *shinwayauth.Auth, apiKey string, stream bool, extraBetas []string, cfg *config.Config, incomingHeaders http.Header) error {
	if r == nil {
		return nil
	}
...
func claudeCreds(a *shinwayauth.Auth) (apiKey, baseURL string) {
	if a == nil {
		return "", ""
	}
	if a.Attributes != nil {
