...
func (e *XAIExecutor) prepareResponsesRequest(ctx context.Context, req shinwayexecutor.Request, opts shinwayexecutor.Options, stream bool) (*xaiPreparedRequest, error) {
	return e.prepareResponsesRequestTo(ctx, req, opts, stream, sdktranslator.FormatCodex)
}

func (e *XAIExecutor) prepareResponsesRequestTo(ctx context.Context, req shinwayexecutor.Request, opts shinwayexecutor.Options, stream bool, to sdktranslator.Format) (*xaiPreparedRequest, error) {
...
func (e *XAIExecutor) recordXAIRequest(ctx context.Context, auth *shinwayauth.Auth, url string, headers http.Header, body []byte) {
...
func xaiCreds(auth *shinwayauth.Auth) (token, baseURL string) {
	if auth == nil {
		return "", ""
	}
...
func xaiUsingAPI(auth *shinwayauth.Auth) bool {
	if auth == nil {
		return true
	}
...
func xaiChatBaseURL(auth *shinwayauth.Auth) string {
...
func xaiCompactBaseURL(auth *shinwayauth.Auth) string {
	_, baseURL := xaiCreds(auth)
...
func applyXAIHeaders(r *http.Request, auth *shinwayauth.Auth, token string, stream bool, sessionID string) {
...
func applyXAICustomHeaders(r *http.Request, auth *shinwayauth.Auth) {
...
// chat-proxy endpoint.
func applyXAIChatHeaders(r *http.Request, auth *shinwayauth.Auth, token string, stream bool, sessionID string) {
	if xaiUsingAPI(auth) {
...
func xaiResolveComposerSessionID(ctx context.Context, req shinwayexecutor.Request, opts shinwayexecutor.Options, baseModel string) (string, error) {
...
func xaiExecutionSessionID(req shinwayexecutor.Request, opts shinwayexecutor.Options) string {
	if value := xaiMetadataString(opts.Metadata, shinwayexecutor.ExecutionSessionMetadataKey); value != "" {
		return value
	}
	if value := xaiMetadataString(req.Metadata, shinwayexecutor.ExecutionSessionMetadataKey); value != "" {
		return value
	}
...
func xaiImageEndpointPath(opts shinwayexecutor.Options) string {
	if opts.SourceFormat.String() != xaiImageHandlerType {
		return ""
	}

	path := xaiMetadataString(opts.Metadata, shinwayexecutor.RequestPathMetadataKey)
...
func xaiIsVideoRequest(opts shinwayexecutor.Options) bool {
	return opts.SourceFormat.String() == xaiVideoHandlerType
}

func xaiVideoEndpointPath(opts shinwayexecutor.Options) string {
