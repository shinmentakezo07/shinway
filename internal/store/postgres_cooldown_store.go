...
var _ shinwayauth.CooldownStateStoreProvider = (*PostgresStore)(nil)
var _ shinwayauth.CooldownStateStore = (*postgresCooldownStateStore)(nil)
...
func (s *PostgresStore) CooldownStateStore() shinwayauth.CooldownStateStore {
	if s == nil {
		return nil
	}
...
func (s *postgresCooldownStateStore) Load(ctx context.Context) (records []shinwayauth.CooldownStateRecord, err error) {
	...
	records = make([]shinwayauth.CooldownStateRecord, 0)
	...
	for rows.Next() {
		...
		var record shinwayauth.CooldownStateRecord
...
func (s *postgresCooldownStateStore) Save(ctx context.Context, records []shinwayauth.CooldownStateRecord) error {
	if s == nil || s.store == nil || s.store.db == nil {
...
func cooldownStateKey(record shinwayauth.CooldownStateRecord) postgresCooldownStateKey {
