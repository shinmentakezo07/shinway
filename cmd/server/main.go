...
import (
	...
	"github.com/shinmentakezo07/shinway/v7/internal/cmd"
	...
	"github.com/shinmentakezo07/shinway/v7/internal/safemode"
...
func main() {
	fmt.Printf("shinway Version: %s, Commit: %s, BuiltAt: %s\n", buildinfo.Version, buildinfo.Commit, buildinfo.BuildDate)
	...
	log.Infof("shinway Version: %s, Commit: %s, BuiltAt: %s", buildinfo.Version, buildinfo.Commit, buildinfo.BuildDate)
