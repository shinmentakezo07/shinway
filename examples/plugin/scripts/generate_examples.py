...
"""
    ...
    go_mod = f"""module github.com/shinmentakezo07/shinway/v7/examples/plugin/{slug}/go
...
project(shinway_{ident}_c C)

add_library(shinway_{ident}_c SHARED src/plugin.c)
set_target_properties(shinway_{ident}_c PROPERTIES
    OUTPUT_NAME "{slug}-c"
    PREFIX ""
)
"""
